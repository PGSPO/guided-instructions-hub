...
import { mockIssues, issueSources, businessFunctions, riskCategories, mockUsers } from "@/lib/issuesMockData";
import { ImpactType, SeverityLevel } from "@/types/issue";
...
export default function IssueDetail() {
  ...
  const handleSubmit = () => {
    // Validation
    if (!formData.title || !formData.summary || !formData.dateOfOccurrence || !formData.dueDate) {
  ...
  const handleRequestExtension = () => {
    if (!formData.extendedDueDate || !formData.extensionJustification) {
      toast.error("Extended due date and justification are required");
      return;
    }
        ...
        <TabsContent value="actions" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Manage action items for this issue</CardDescription>
            </CardHeader>
            <CardContent>
